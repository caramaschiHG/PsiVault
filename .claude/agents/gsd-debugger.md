...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/caramaschi/Área de trabalho/Projetos/PsiLock/.claude
                  → checks /home/caramaschi/Área de trabalho/Projetos/PsiLock/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/caramaschi/Área de trabalho/Projetos/PsiLock/.claude/get-shit-done
                  → writes to /home/caramaschi/Área de trabalho/Projetos/PsiLock/.claude/get-shit-done/hooks/
...
@/home/caramaschi/Área de trabalho/Projetos/PsiLock/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/caramaschi/Área de trabalho/Projetos/PsiLock/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/home/caramaschi/Área de trabalho/Projetos/PsiLock/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/caramaschi/Área de trabalho/Projetos/PsiLock/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/caramaschi/Área de trabalho/Projetos/PsiLock/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
