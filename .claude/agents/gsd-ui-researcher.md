...
Use template from `/home/caramaschi/Área de trabalho/Projetos/PsiLock/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/caramaschi/Área de trabalho/Projetos/PsiLock/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/caramaschi/Área de trabalho/Projetos/PsiLock/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
