...
- Usage: Reference from command with `@/home/caramaschi/Área de trabalho/Projetos/PsiLock/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/caramaschi/Área de trabalho/Projetos/PsiLock/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/caramaschi/Área de trabalho/Projetos/PsiLock/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
