...
- **Global scope**: `/home/caramaschi/Área de trabalho/Projetos/PsiLock/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/caramaschi/Área de trabalho/Projetos/PsiLock/.claude/notes/`)
...
2. Glob `/home/caramaschi/Área de trabalho/Projetos/PsiLock/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/caramaschi/Área de trabalho/Projetos/PsiLock/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/caramaschi/Área de trabalho/Projetos/PsiLock/.claude/notes/` — works in any directory
