  ...
  return (
    <form action={updateAction} style={{ display: "grid", gap: "1.25rem" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "1.25rem", paddingTop: "0.5rem" }}>
        <Link href={backHref} style={{ padding: "0.75rem 1.5rem", borderRadius: "var(--radius-lg)", background: "var(--color-surface-0)", color: "var(--color-text-2)", border: "1px solid var(--color-border-med)", fontWeight: 600, fontSize: "0.95rem", textDecoration: "none", cursor: "pointer", fontFamily: "inherit" }}>
          Voltar
        </Link>
