...
// Mock async section using React.use (Client Component pattern)
...
describe("AsyncBoundary", () => {
  it("renders async section through AsyncBoundary", async () => {
    await act(async () => {
      render(
  ...
  it("renders custom error fallback when provided", async () => {
    ...
    expect(await screen.findByTestId("custom")).toHaveTextContent("Section failed");
  });
